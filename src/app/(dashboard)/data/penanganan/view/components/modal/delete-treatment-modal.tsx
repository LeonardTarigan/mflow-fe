...
import useDeleteTreatment from "../../../hooks/useDeleteTreatment";
...
export default function DeleteTreatmentModal({
  ...
  const { mutateAsync, isPending } = useDeleteTreatment(setOpen);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div>
          <p>
            Apakah Anda yakin ingin menghapus data penanganan{" "}
