...
export type TAddPatientFormSchema = z.infer<typeof formSchema>;

export default function useAddPatientForm(
  defaultValues?: TAddPatientFormSchema,
) {
  const form = useForm<TAddPatientFormSchema>({
